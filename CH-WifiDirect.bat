...
REM I have seen that when you connect the RC to the computer and create a group that connects the RC and DS
REM it provides a password and you connect from the computer using that remembered group password to the remembered group
@echo off
